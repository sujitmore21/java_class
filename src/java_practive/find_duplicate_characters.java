...
public class find_duplicate_characters {
    ...
    public static void main(String a[]){
        find_duplicate_characters obj = new find_duplicate_characters();
        System.out.println("String: sujitmoremore.com");
        System.out.println("-------------------------");
        obj.countDupChars("sujitmoremore.com");

        System.out.println("\nString: sujitmoresujit");
        System.out.println("-------------------------");
        obj.countDupChars("sujitmoresujit");
